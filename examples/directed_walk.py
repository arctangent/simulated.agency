...
simulation.seed(Walker, 0.1, MoveTowardsLocation, location=target_location)
...
# Run the simulation
simulation.execute(before_each_loop=maybe_move_target, before_each_agent=update_agent, draw_locations=False)
